 ...
 * generated in the spring.ejemplos.diecisiete.ws.cxf.client.jaxwsgeneratedcode package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: spring.ejemplos.diecisiete.ws.cxf.client.jaxwsgeneratedcode
     * 
     */
